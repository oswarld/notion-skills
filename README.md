<p align="center">
  <a href="https://skills.inlevel9.com">
    <img src="public/skills-logo.png" alt="인레벨나인 스킬 로고" width="100">
  </a>
</p>
...
<p align="center">
  <a href="https://skills.inlevel9.com/catalog"><img src="https://img.shields.io/badge/%EA%B8%B0%EB%B3%B8_%EC%8A%A4%ED%82%AC-15%EA%B0%9C-0ea5e9?style=flat-square" alt="기본 스킬 15개"></a>
  <a href="https://skills.inlevel9.com"><img src="https://img.shields.io/badge/%EC%96%B8%EC%96%B4-%ED%95%9C%EA%B5%AD%EC%96%B4-8b5cf6?style=flat-square" alt="한국어 서비스"></a>
  <a href="package.json"><img src="https://img.shields.io/badge/%EC%BD%94%EB%93%9C-TypeScript-3178c6?style=flat-square&amp;logo=typescript&amp;logoColor=white" alt="작성 언어 TypeScript"></a>
  <a href="https://bun.sh"><img src="https://img.shields.io/badge/%EB%9F%B0%ED%83%80%EC%9E%84-Bun-14151a?style=flat-square&amp;logo=bun&amp;logoColor=white" alt="실행 환경 Bun"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/%EB%9D%BC%EC%9D%B4%EC%84%A0%EC%8A%A4-MIT-22c55e?style=flat-square" alt="MIT 라이선스"></a>
  <a href="https://github.com/oswarld/notion-skills/stargazers"><img src="https://img.shields.io/github/stars/oswarld/notion-skills?style=flat-square&amp;label=%EC%8A%A4%ED%83%80&amp;color=e3b341" alt="GitHub 스타 수"></a>
</p>
...
기본 스킬 15개에는 모두 **Notion AI에 전달할 판단 질문과 기준**을 담았습니다. 사용자는 자료를 넣거나 현재 Notion 페이지를 작업 대상으로 선택하고, 필요한 업무 기준을 덧붙입니다. 도구는 이 내용으로 요청문을 준비하고, 실제 판단과 답변은 사용 중인 Notion AI에서 받습니다.

| 스킬에 담는 내용 | 회의록 정리 예시 |
| --- | --- |
| 입력 자료 | 회의 메모, 공유 대상, 원하는 형식 |
| 판단 질문 | 합의한 결정인가, 아직 검토 중인 제안인가? |
| 판단 기준 | 원문에 명시적인 합의나 확정 표현이 있는지 확인 |
| 정보가 부족할 때 | 합의 여부, 담당자, 기한을 추측하지 않고 미결 사항으로 정리 |
| 결과 형식 | 결정·제안·할 일을 구분하고, 짧은 원문 근거와 보완할 정보 표시 |

[회의록 정리](https://skills.inlevel9.com/catalog/meeting-notes)와 [문서 검토](https://skills.inlevel9.com/catalog/document-review) 화면에서 각 기준을 펼쳐 볼 수 있습니다. 같은 기준을 복사한 요청문과 다운로드한 스킬에도 포함합니다. 다른 기본 스킬도 업무에 맞는 질문, 판단 기준, 정보가 부족할 때의 처리 방식, 결과 형식을 제공합니다.

스킬은 AI가 일을 처리할 때 참고하는 작업 지침입니다. 무엇을 입력해야 하는지, 어떤 순서로 살펴봐야 하는지, 결과를 어떤 형식으로 정리해야 하는지를 담고 있습니다.

INLEVEL9 Skills에서는 기본 스킬을 바로 사용하거나, Notion에서 관리하는 스킬을 연결해 내려받을 수 있습니다. 팀에서 사용한다면 명령줄 도구로 Notion의 스킬을 GitHub에 필요할 때 동기화할 수도 있습니다.

| 바로 써 보는 기본 스킬 | 내 Notion 스킬 연결 | 팀 스킬 수동 동기화 |
| --- | --- | --- |
| 업무에 맞는 한국어 스킬 15개 | Notion에서 허용한 스킬 묶음 조회 | Notion → GitHub 수동 동기화 |
| 예시 확인 → 내 내용 입력 → 요청 복사 | Notion 로그인 → 공유 대상 선택 → 다운로드 | 명령줄 도구로 필요할 때 실행 |
| 로그인·설치 없이 시작 | 사용자용 API 토큰 발급 불필요 | 팀의 스킬을 한곳에서 관리·배포 |

<p align="center">
  <a href="https://skills.inlevel9.com/catalog">
    <img src="docs/marketplace/catalog-preview.png" alt="업무 검색, 사용자 필터와 한국어 스킬 카드를 제공하는 스킬 목록 화면" width="960">
  </a>
</p>
...
2. **판단 기준을 확인하고 자료를 정하세요.** 직접 내용을 넣거나 현재 Notion 페이지를 선택합니다. 팀의 용어나 우선순위를 추가할 수도 있습니다.
3. **만들어진 요청을 복사해 Notion AI 대화에 붙여넣으세요.** 다른 AI 대화에서도 사용할 수 있습니다. 모든 기본 스킬이 자료와 판단 기준을 함께 전달합니다. 스킬 파일을 지원하는 앱에서는 내려받은 파일을 활용할 수도 있습니다.

전체 작업 지침은 판단 기준이 포함된 `.md` 한 파일로, 앱에 설치할 스킬은 `SKILL.md`와 판단 기준 파일이 포함된 `.zip`으로 내려받습니다. 설명과 작업 지침은 한국어로 제공하므로 내용을 읽고 업무에 맞게 수정할 수 있습니다. 이 서비스는 작업 지침을 준비하며, 실제 AI의 답변 생성은 사용자가 선택한 AI 앱에서 이루어집니다.
...
웹 서비스의 로그인·다운로드 기능과는 별도로 설정합니다. GitHub Actions 예약 실행은 포함하지 않으며, 필요할 때 로컬에서 동기화 명령을 직접 실행합니다.
...
이 명령은 로컬 설정 순서를 안내합니다. 파일 수정, 데이터베이스 생성, 커밋·푸시, GitHub Actions 설정을 자동으로 실행하지 않습니다.

1. 기존 `.env`가 없다면 `.env.example`을 복사합니다. 기존 파일이 있으면 필요한 값만 추가합니다.
2. Notion 토큰과 동기화할 GitHub 저장소를 설정합니다.
3. `bun run dry-run`으로 변경 내용을 먼저 확인합니다.
4. 대상 저장소에 반영할 때만 `bun run sync`를 실행합니다.

Notion 스킬 데이터베이스를 준비하는 방법은 [설정 지침](AGENTS.md)을 참고하세요. 기본 스킬을 사용하거나 Notion AI에 요청문을 전달하는 데 이 설정은 필요하지 않습니다.
...
로컬 실행에서는 `.env`에 `NOTION_API_TOKEN`과 대상 GitHub 저장소 설정을 입력합니다. 이 저장소에는 예약 실행 워크플로가 없으므로 토큰을 GitHub Actions Secret으로 등록할 필요가 없습니다.
...
새로운 스킬 제안이나 개선 의견은 [이슈](https://github.com/oswarld/notion-skills/issues)에 남겨 주세요. 사용과 운영에 필요한 문서는 한국어로 제공합니다.

| 알고 싶은 내용 | 문서 |
| --- | --- |
| 웹 서비스의 연결·배포·데이터 처리 | [웹 서비스 운영 안내](web/README.md) |
| 로컬 동기화와 테스트 설정 | [동기화 설정 안내](setup/README.md) · [단계별 설정 지침](AGENTS.md) |
| 기본 스킬을 선정한 배경 | [카탈로그 조사와 공개 계획](docs/catalog-research.md) |
| 실제로 확인한 동작과 검증의 한계 | [판단 가이드 검증 기록](docs/decision-guide-verification.md) |
| 마켓플레이스 등록과 정책 초안 이력 | [마켓플레이스 진행 기록](docs/marketplace-listing.md) |
...
<p>
  <a href="https://inlevel9.com/about"><img src="https://img.shields.io/badge/%EC%A0%9C%EC%9E%91%EC%9E%90_%EC%86%8C%EA%B0%9C-INLEVEL9-263d36?style=for-the-badge" alt="안광섭 소개 페이지"></a>
  <a href="https://www.linkedin.com/in/oswarld/"><img src="https://img.shields.io/badge/LinkedIn-%ED%94%84%EB%A1%9C%ED%95%84-0a66c2?style=for-the-badge" alt="안광섭 LinkedIn 프로필"></a>
</p>

자세한 이력과 활동은 [INLEVEL9 소개](https://inlevel9.com/about)와 [LinkedIn 프로필](https://www.linkedin.com/in/oswarld/)에서 확인할 수 있습니다.

<p>
  <img src="docs/assets/made-for-notion-white.png" alt="Notion을 위해 만든 서비스 공식 배지" width="176">
  &nbsp;
  <img src="docs/assets/notion-certified-consultant.png" alt="제작자의 Notion 인증 컨설턴트 공식 배지" width="256">
</p>
